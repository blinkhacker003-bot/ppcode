...
var UHTEventBroker = function() {
    ...
    function sendToGame(json) {
        ...
        switch (msg) {
            case "EVT_GET_CONFIGURATION":
                ...
                if (config["replayMode"] == true) {
                    var url = config["replaySystemUrl"] + "/ReplayService/api/replay/data?token=" + config["mgckey"] + "&roundID=" + config["replayRoundId"] + "&envID=" + config["environmentId"];
    ...
    function sendMessagesToGame() {
        if (gameLoaded) {
            for (var i =
                    0; i < messagesToGame.length; ++i) triggerEvent(EM.Type.Game, messagesToGame[i]);
            messagesToGame = []
    ...
    function onLoad() {
        ...
        if (sendToAdapterOriginal == null) sendToAdapterOriginal =
    ...
    EM.Handler.prototype.equals = function(object, callback) {
        return object ==
            this.object && callback == this.callback
    };
...
function UHTVarsInjected() {
    var ProcessGameInfo = function() {
        var items = [];
        items = String(UHT_GAME_SIZE).split(",");
    ...
    var LoadL10nCallback = function(responseText) {
        ...
        ++numL10nLoadedFiles;
        if (numL10nLoadedFiles ==
            numL10nFilesToLoad) SetUHTResources()
    };
    var GetL10nFiles = function() {
        ...
        for (var i = 0; i < languages.length; ++i)
            if (languages[i]["language"] == UHT_CONFIG.LANGUAGE) {
                ...
                for (var j = 0; j < bundles.length; ++j) filesToLoad.push(path +
                    bundles[j]["name"] + suffix);
                found = true
            }
    ...
    var LoadCustomizationsInfo = function() {
        new PackageLoader(UHT_CONFIG.GAME_URL +
            "customizations.info", OnCustomizationsInfoLoaded, false)
    };
    ...
    var OnCustomizationLoaded = function(responseText) {
        if (responseText !=
            null) loadedCustomizationFiles.push(responseText);
        customizationLoaded = true;
        SetUHTResources()
    };
    LoadL10ns();
...
UHT_GAME_SIZE = 'game000:1015116,game001:1687918,game002:1310474,game003:569403,game_fileIDs:116936,';
UHT_RESOURCES_SIZE = 'main_resources000:698758,main_resources001:541649,main_resources002:585867,main_resources003:805361,main_resources004:1189766,main_resources005:1012258,main_resources006:624779,main_resources007:762085,main_resources008:566600,main_resources009:2527647,main_resources010:626095,main_resources011:946626,main_resources012:534016,main_resources013:1205541,main_resources014:688959,main_resources015:545951,main_resources016:552497,main_resources017:940588,main_resources018:545435,main_resources019:426090,other_resources000:622166,other_resources001:131898,';
UHT_GUI_SIZE = 'GUI000:847085,GUI001:976294,GUI002:1273621,GUI003:553485,GUI004:588252,GUI005:574284,GUI006:547838,GUI007:585520,GUI008:890470,GUI009:766540,GUI010:939630,GUI011:332764,GUI_fileIDs:548538,';
UHT_GUI_RESOURCES_SIZE = 'GUI_resources000:722988,GUI_resources001:1119484,GUI_resources002:536664,GUI_resources003:736851,GUI_resources004:737062,GUI_resources005:813563,GUI_resources006:537545,';
UHT_SOUNDS_SIZES = 'GUI_sounds.mp3:328213,GUI_sounds.ogg:363181,sounds.mp3:7250285,sounds.ogg:7540545,';
